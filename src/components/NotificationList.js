...
const NotificationList = () => {
  ...
  const fetchNotifications = async () => {
    try {
      const res = await fetch(
        'https://users.mpdatahub.com/api/notifications/list'
      );
  ...
  const deleteNotification = async (id) => {
    ...
    try {
      const res = await fetch(
        `https://users.mpdatahub.com/api/deletenotification/${id}`,
        { method: 'GET' }
      );
  ...
  return (
    <div className="notification-containerntn">
      ...
      {loading ? (
        <div className="dashboard-loadingdashntn">Loading notifications...</div>
