...
export default function AccountSettings() {
  ...
  const [selectedStatus, setSelectedStatus] = useState(creator?.status);
        ...
        <div className="as-col-left">
          ...
          <div className="as-card">
            ...
            <div className="as-profile">
              ...
              >
                {creator.logo ||
                  creator.channel_name?.slice(0, 2).toUpperCase()}
              </div>
              <div className="as-profile-info">
                <p className="as-channel-name">{creator.channel_name}</p>
                <p className="as-owner-name">{creator.name}</p>
                <p className="as-username">@{creator.name}</p>
              </div>
            </div>
          </div>
